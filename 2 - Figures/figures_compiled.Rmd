...
# use loop instead of function to reduce code you have to write in ODE
# probably should shore up but for now lazily passing result
for(vals in 1:nrow(df)){
...
print("Cutting contact rates in half after 15 days (Josh's additional request)")
#### NOTE: Code is hacky, but might be decent start
