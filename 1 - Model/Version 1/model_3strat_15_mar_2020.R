...
model_strat <- function (t, x ,...) {
  ...
  ###### Equations
  ### YOUNG
  dS1dt = -S1*p*(v11*I1 + vA11*A1 + v21*I2 + vA21*A2 + v31*I3 + vA31*A3 + v1Q1*I1Q + vA1Q1*A1Q + v2Q1*I2Q + vA2Q1*A2Q + v3Q1*I3Q + vA3Q1*A3Q)          
  dE1dt = -delta*E1+ S1*p*(v11*I1 + vA11*A1 + v21*I2 + vA21*A2 + v31*I3 + vA31*A3 + v1Q1*I1Q + vA1Q1*A1Q + v2Q1*I2Q + vA2Q1*A2Q + v3Q1*I3Q + vA3Q1*A3Q)
  dI1dt = (1-alpha1)*epsilon*A1 - (m1*omega + (1-m1)*gamma)*I1                                                
  dA1dt = delta*E1-(1-alpha1)*epsilon*A1-gamma*A1                                                                                                      
  dR1dt = gamma*A1+ (1-m1)*gamma*I1
  It1 = (1-alpha1)*epsilon*A1
  At1 = delta*E1
  
  ### MEDIUM
  dS2dt = -S2*p*(v12*I1 + vA12*A1 + v22*I2 + vA22*A2 + v32*I3 + vA32*A3 + v1Q2*I1Q + vA1Q2*A1Q + v2Q2*I2Q + vA2Q2*A2Q + v3Q2*I3Q + vA3Q2*A3Q)          
  dE2dt = -delta*E2+ S2*p*(v12*I1 + vA12*A1 + v22*I2 + vA22*A2 + v32*I3 + vA32*A3 + v1Q2*I1Q + vA1Q2*A1Q + v2Q2*I2Q + vA2Q2*A2Q + v3Q2*I3Q + vA3Q2*A3Q)
  dI2dt = (1-alpha2)*epsilon*A2- (m2*omega + (1-m2)*gamma)*I2                                                
  dA2dt = delta*E2-(1-alpha2)*epsilon*A2-gamma*A2                                                                                                      
  dR2dt = gamma*A2+ (1-m2)*gamma*I2
  It2 = (1-alpha2)*epsilon*A2
  At2 = delta*E2
  
  ### OLD
  dS3dt = -S3*p*(v13*I1 + vA13*A1 + v23*I2 + vA23*A2 + v33*I3 + vA33*A3 + v1Q3*I1Q + vA1Q3*A1Q + v2Q3*I2Q + vA2Q3*A2Q + v3Q3*I3Q + vA3Q3*A3Q)          
  dE3dt = -delta*E3+ S3*p*(v13*I1 + vA13*A1 + v23*I2 + vA23*A2 + v33*I3 + vA33*A3 + v1Q3*I1Q + vA1Q3*A1Q + v2Q3*I2Q + vA2Q3*A2Q + v3Q3*I3Q + vA3Q3*A3Q)
  dI3dt = (1-alpha3)*epsilon*A3- (m3*omega + (1-m3)*gamma)*I3                                               
  dA3dt = delta*E3-(1-alpha3)*epsilon*A3-gamma*A3                                                                                                      
  dR3dt = gamma*A3+ (1-m3)*gamma*I3
  It3 = (1-alpha3)*epsilon*A3
  At3 = delta*E3
  
  ### YOUNG - SOCIALLY DISTANCED
  dS1Qdt = -S1Q*p*(v11Q*I1 + vA11Q*A1 + v21Q*I2 + vA21Q*A2 + v31Q*I3 + vA31Q*A3 + v1Q1Q*I1Q + vA1Q1Q*A1Q + v2Q1Q*I2Q + vA2Q1Q*A2Q + v3Q1Q*I3Q + vA3Q1Q*A3Q)           
  dE1Qdt = -delta*E1Q+ S1Q*p*(v11Q*I1 + vA11Q*A1 + v21Q*I2 + vA21Q*A2 + v31Q*I3 + vA31Q*A3 + v1Q1Q*I1Q + vA1Q1Q*A1Q + v2Q1Q*I2Q + vA2Q1Q*A2Q + v3Q1Q*I3Q + vA3Q1Q*A3Q)
  dI1Qdt = (1-alpha1Q)*epsilon*A1Q- (m1Q*omega + (1-m1Q)*gamma)*I1Q                                                     
  dA1Qdt = delta*E1Q-(1-alpha1Q)*epsilon*A1Q-gamma*A1Q                                                                                                                
  dR1Qdt = gamma*A1Q+ (1-m1Q)*gamma*I1Q 
  It1Q = (1-alpha1Q)*epsilon*A1Q
  At1Q = delta*E1Q
  
  ### MEDIUM - SOCIALLY DISTANCED
  dS2Qdt = -S2Q*p*(v12Q*I1 + vA12Q*A1 + v22Q*I2 + vA22Q*A2 + v32Q*I3 + vA32Q*A3 + v1Q2Q*I1Q + vA1Q2Q*A1Q + v2Q2Q*I2Q + vA2Q2Q*A2Q + v3Q2Q*I3Q + vA3Q2Q*A3Q)           
  dE2Qdt = -delta*E2Q+ S2Q*p*(v12Q*I1 + vA12Q*A1 + v22Q*I2 + vA22Q*A2 + v32Q*I3 + vA32Q*A3 + v1Q2Q*I1Q + vA1Q2Q*A1Q + v2Q2Q*I2Q + vA2Q2Q*A2Q + v3Q2Q*I3Q + vA3Q2Q*A3Q)
  dI2Qdt = (1-alpha2Q)*epsilon*A2Q- (m2Q*omega + (1-m2Q)*gamma)*I2Q                                                     
  dA2Qdt = delta*E2Q-(1-alpha2Q)*epsilon*A2Q-gamma*A2Q                                                                                                                
  dR2Qdt = gamma*A2Q+ (1-m2Q)*gamma*I2Q         
  It2Q = (1-alpha2Q)*epsilon*A2Q
  At2Q = delta*E2Q
  
  ### OLD - SOCIALLY DISTANCED
  dS3Qdt = -S3Q*p*(v13Q*I1 + vA13Q*A1 + v23Q*I2 + vA23Q*A2 + v33Q*I3 + vA33Q*A3 + v1Q3Q*I1Q + vA1Q3Q*A1Q + v2Q3Q*I2Q + vA2Q3Q*A2Q + v3Q3Q*I3Q + vA3Q3Q*A3Q)           
  dE3Qdt = -delta*E3Q+ S3Q*p*(v13Q*I1 + vA13Q*A1 + v23Q*I2 + vA23Q*A2 + v33Q*I3 + vA33Q*A3 + v1Q3Q*I1Q + vA1Q3Q*A1Q + v2Q3Q*I2Q + vA2Q3Q*A2Q + v3Q3Q*I3Q + vA3Q3Q*A3Q)
  dI3Qdt = (1-alpha3Q)*epsilon*A3Q- (m3Q*omega + (1-m3Q)*gamma)*I3Q                                                     
  dA3Qdt = delta*E3Q-(1-alpha3Q)*epsilon*A3Q-gamma*A3Q                                                                                                                
  dR3Qdt = gamma*A3Q + (1-m3Q)*gamma*I3Q   
  It3Q = (1-alpha3Q)*epsilon*A3Q
  At3Q = delta*E3Q
...
# read in parameters
params = read.csv("parameters_16_mar_2020.csv")[-2,]
attach(params)
