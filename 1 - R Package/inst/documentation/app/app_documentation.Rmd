...
```{r render_model_diagram, cache=TRUE, out.width='90%'}
# Plot model diagram from DiagrammeR
model_diagram_file <- file.path(tempdir(), 'diagram.png')
export_model_diagram_to_png(model_diagram_file)
knitr::include_graphics(model_diagram_file)
```
